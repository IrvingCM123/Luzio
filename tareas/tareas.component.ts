...
export class TareasComponent implements OnInit {
  IMC: string = "";
  Estres: string = "";
  constructor(private mandar: CacheService) {
    this.IMC = mandar.obtener_DatoLocal("IMC");
    this.Estres = mandar.obtener_DatoLocal("Estres");
  }
  ...
  async peticion2() {
    ...
    let url = "http://192.168.137.1:3000/act-nivel-estres/act/" + this.Estres;
